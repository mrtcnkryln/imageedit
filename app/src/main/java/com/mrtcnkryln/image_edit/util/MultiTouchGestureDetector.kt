...
class MultiTouchGestureDetector(context: Context, listener: OnMultiTouchGestureListener) {
    ...
    val TAG = "MultiTouchGestureDetector"
    ...
    private var mListener: OnMultiTouchGestureListener? = null

    private var mCurrentFocusX: Float = 0.toFloat()
    private var mCurrentFocusY: Float = 0.toFloat()

    private var mPreviousFocusX: Float = 0.toFloat()
    private var mPreviousFocusY: Float = 0.toFloat()

    private var mCurrentSpan: Float = 0.toFloat()
    private var mPreviousSpan: Float = 0.toFloat()

    private var mCurrentRotation: Float = 0.toFloat()
    private var mPreviousRotation: Float = 0.toFloat()
    ...
    private var mSpanSlop: Int? = null

    private var mInitialFocusX: Float = 0.toFloat()
    private var mInitialFocusY: Float = 0.toFloat()
    private var mTouchSlopSquare: Int? = null
    ...
    fun getScale(): Float {
        if(mPreviousSpan > 0){
            return mCurrentSpan / mPreviousSpan
        } else {
            return 1.0f
        }
    }
